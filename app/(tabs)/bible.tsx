...
export default function EBibleScreen() {
  ...
  return (
    ...
    >
      ...
      <View style={[styles.topHeaderArea, { borderBottomColor: colors.border, backgroundColor: colors.glassBackground }]}>
        ...
        {showSearchResults && (
          <View style={[styles.searchResultsOverlay, { backgroundColor: colors.glassCardElevated, borderColor: colors.glassBorder }]}>
      ...
      >
        <TouchableWithoutFeedback onPress={() => setReadingVerse(null)}>
          <View style={styles.modalBackdrop}>
            <TouchableWithoutFeedback>
              <View style={[styles.modalCard, { backgroundColor: colors.glassCardElevated, borderColor: colors.glassBorder }]}>
                {/* Header */}
                <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
                  ...
                  <TouchableOpacity
                    ...
                    style={[styles.modalCloseBtn, { backgroundColor: colors.glassInput }]}
      ...
      >
        <TouchableWithoutFeedback onPress={() => setShowVersionPicker(false)}>
          <View style={styles.modalBackdrop}>
            <TouchableWithoutFeedback>
              <View style={[styles.versionModalCard, { backgroundColor: colors.glassCardElevated, borderColor: colors.glassBorder }]}>
                <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
                  <View style={styles.modalHeaderTitleRow}>
